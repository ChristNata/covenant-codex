...
| A18 | Publish the Windows-only fanin fork artifact before Harness F32 handoff. | User explicitly defers Harness-side implementation while authorizing the fork release. F31/F33 certify the tagged fork binary, inventory, tests and attestation; they do not certify Harness project-resolution, role ACL or cancellation behavior. Keep Official as the active fallback and do not switch the Harness pin until those external gates are verified. Record the pending handoff in release notes. |
...
### F21 marker parser helper - local phase complete; Bazel compatibility open

Base `07e6b653954c44550f7f12ea5dd5fe2e34bc9b65`. Actual list/run used `package(codex-cli) & test(http::marker_tests::marker_)`; inspected native listing enforced the exact five frozen nonignored cases, while the Windows retry-zero override retained its exact-name disjunction. Run `5a2719d9-4347-4a18-892d-be0431df8f0f`: native0, 5PASS, 26 excluded, 0.076s. Execution evidence `f21-effects-marker-execution-final.json` SHA-256 `738fd1aff5bc61677336a5cb8bd0b52c36b765f602762944cb73221100615a52`; raw run log `85ed7faf4d9348474be6740882e53adaec291dd7adbff4ed493ee60b370727fc`.

Exact-target `bazel build --lockfile_mode=error //codex-rs/cli/testing:covenant-hook-mcp-effects-test` completed analysis, then exited native1 in external serde with E0463 (`serde_derive`) before successful owned-target compilation. Raw log `137731dd4a0a01b5023de5d8f1b8b4b923af720a0bbf81208f05e372ead6f7de`. The Bazel derive/RawValue compatibility gate remains unclosed; no cause, repair, retry or Bazel test result is established.

Hygiene `f21-effects-marker-hygiene-final.json` SHA-256 `11d9c4292f20d9e5d58ab489e85ea578963119de69a0d790f006ed4a749e59f0`: scoped Clippy/fixer0; required `just fmt` failed1 with Windows os206 and all191 unrelated touches restored; bounded three-file fallback fmt/check both0 with the stable rustfmt nightly-only `imports_granularity=Item` warning. Marker layout inverse exactly reconstructs tested `5ef67db9879de4a55ff53b4d3f62f55aecd1ee3e8f83d41916b6e0cdd69e937f` from final `d215f60382f4ce0cd53a9c173a39a2eae740c7ffddd93e0ef01acf0418c1b0a4`; tests remain byte-identical and were not rerun after formatting. Final five-path source/setup scope is +223/-0 before this ledger entry.

Post-execution independent review `f21-effects-marker-post-execution-review.md` SHA-256 `cdc98e071272fddb009902e59656858b3b695c98c6c4f690a9bff391d1351bc5` accepts bounded Cargo-local parser evidence with the Bazel limitation; final independent hygiene/source review `.git/covenant-session/f21-effects-marker-final-review.md` SHA-256 `492de9efc6cab96961e0864cd89ad4b2c8372297a07fc1952c18035dfafb454e` completed with bounded PASS. This proves only the private marker parser: no marker writer/CreateNew, script, shell, actual Codex child, criterion-5 closure, G4 or release acceptance.

### F21 Responses peer adapter - local phase complete; Bazel compatibility open

Base `c31bc14af440ca945a483ca080fac2ea75ba63ff`. Actual list/run used `package(codex-cli) & test(http::responses_owner_tests::responses_owner_)`; inspected native listing enforced exactly two nonignored cases, with the Windows retry-zero override retaining its exact-name selector. Run `168c0473-96b3-407a-b5c0-736bb36c1272`: native0, 2PASS, 31 excluded, 0.111s. Execution evidence `f21-effects-responses-owner-execution-final.json` SHA-256 `347d0a1e1ad04ce6e0400d07a3ae7b93bc4e067832003de232d45e3037757b03`.

The positive case observes authenticated 426-to-POST fallback with a body larger than 32KiB, complete SSE reply and natural owned settlement. The negative case retains the same finish future while the client write side remains open, then sends a late byte and requires `Framing` after cleanup. Saved assertions/results establish these observations; the full raw wire exchange was not independently archived.

Hygiene `f21-effects-responses-owner-hygiene-final.json` SHA-256 `af6078125a752af058fe89b9cd97b228eafcdcb12018828b5a9dff5199a8451d`: scoped Clippy/fixer0; required `just fmt` failed1 with Windows os206 and all191 unrelated touches restored; bounded three-file fallback fmt/check both0 with the stable rustfmt nightly-only `imports_granularity=Item` warning. Exact layout inverses restore tested peer and test bytes; no tests were rerun after formatting. Final five-path source/setup scope is +280/-9 before this ledger entry. The inherited external serde E0463 Bazel gate remains open; no cause, fix or retry is claimed.

Post-execution independent review `f21-effects-responses-owner-post-execution-review.md` SHA-256 `c9624926591d7d4b3cb97f22132d105a483d060eee26fb30b47fdbe1f9442f80` accepts bounded local adapter evidence; final independent hygiene/source review `.git/covenant-session/f21-effects-responses-owner-final-review.md` SHA-256 `6f68142af587cf07981ee1a333ce08fbbcf158631cd590b428ba838323eed1c7` completed with bounded PASS. This covers only the owned Responses socket fixture with synthetic child status, not an actual Codex child, outer cancellation wrapper, descendant/global absence, criterion-5 closure, G4 or release acceptance.

### F21 receipt codec helper - local phase complete

Base `e260c0c2050af3007da89c96a9cc4190da1b5a85`. Actual list/run selected `package(codex-cli) & test(receipt_tests::receipt_)`; inspected listing enforced the exact six nonignored cases, with the Windows/local exact-name override retaining retries0 and inherited timeout behavior. Run `6c2ed1ce-940b-49d9-9312-edc08ab75c33`: native0, 6PASS, 33 excluded, 1.667s. Execution `f21-effects-receipt-execution-final.json` SHA-256 `996e655e18cc0c332dedb5356b3bd3f282da91472765ae8934c6493feced7048` binds the actual file/readback, CreateNew-before-serialization, duplicate preservation, exact16MiB/overflow, sentinel-before-decoder, malformed-input and recovery controls.

Hygiene `f21-effects-receipt-hygiene-final.json` SHA-256 `7b294bbb7641d6ce82c8d2875f9f20407ce350428a050bd05fc3f49f4b01547b`: scoped Clippy/fixer0 with no changes; owned three-file fmt/check both0 under the controlling fork AGENTS scope, with the stable rustfmt nightly-only `imports_granularity=Item` warning. Exact raw inverses restore the tested181-line owner and210-line tests from final177/272-line layouts; no assertions changed and no tests were rerun. Final five-path source/setup scope is +465/-0 before this ledger entry.

Independent post-test review `f21-effects-receipt-post-execution-independent-review.md` SHA-256 `c5bf49382dbf288ea49d7d725007c7b846ddd8896d296e55f8516bf5bd443ff2` and final review `f21-effects-receipt-final-independent-review.md` SHA-256 `f36410d6cbf46e67e8417780c5fd9e457e96b72a6d8f0c72e1a9f273234de5df` PASS. The inherited external serde E0463 Bazel gate remains open; no cause, fix, retry or successful owned-target Bazel result is established.

This completes only the private generic receipt codec. Its raw byte caps do not bound caller serializer/decoder allocation, external writes or kernel buffers; File drop cannot report a final close error. Fixed names and bounded reads do not establish concurrent-filesystem identity protection or an atomic snapshot. Actual CLI receipt fields, binary/mode/archive/PASS binding, child behavior, criterion5, G4/C7 and release acceptance remain unproven.

### F21 P0 controlled direct-child helper - local phase complete

Base `85b64456ce468d37c39da0aa010e14dc1f0cb19b`. Actual list/run selected `package(codex-cli) & test(child_tests::child_)`, with the inspected exact three nonignored cases. Run `59f6a7fc-9e68-4d80-bd19-bb33abf5fb35`: native0, 3PASS, 39 excluded, 10.443s. Execution `f21-effects-child-execution-final.json` SHA-256 `1fdb1033de3a3b5a8f828ae7bcee731c50085568ae1a3cf7d1b16e9296796166` binds seven controlled direct PowerShell children covering full UTF-8/cwd/arguments/native status, bounded input/output, deadline and retained same-future cancellation cleanup. Successful stdout and PIDs are live assertions only, not an independent raw archive.

Hygiene `f21-effects-child-hygiene-final.json` SHA-256 `9f15623b851dd60967ed1a17ce35cbc1c1706e605f34b8eda7d5aba47f1cef3e`: scoped Clippy/fixer0 without diagnostics or byte changes; owned three-file fmt/check0 under the fork AGENTS scope, with the stable nightly-only imports_granularity warning. Exact raw inverses restore tested owner230/tests224 from final236/313; the embedded script and assertions are unchanged. No tests were rerun. The explicit +567/-0 source/setup size exception applies only to this cohesive five-path, registered and exercised child-ownership cohort; this ledger is separate and the exception does not extend to later stages.

Final independent review `f21-effects-child-final-review.md` SHA-256 `adb1928c1a2de444f29423fea1f9b972f4d4158ab1c7a804c151ac43a42d9c0d` PASS, integrity `f21-effects-child-final-integrity.json` SHA-256 `f2106b7d660a94faaf37485a7dae2fc8a90037d8070f2a3331357519fca527be`. The inherited external serde E0463 Bazel gate remains open; no cause, fix, retry or owned-target Bazel success is established.

This completes only the private direct-child helper. Cleanup can exceed the operation deadline; retained kill/wait and task joins have no finite-return guarantee. Entire-future Drop yields no settled report. No descendant containment, actual Codex CLI hook, independent output/receipt binding, criterion5, G4 or release acceptance is established.

### F21 P1 generated hook-command helper - local phase complete

Base `24b7a7e94745d42aa8cba686ab74773fe10b75a8`. Native listing selected exactly1 case and excluded42; gate `f21-effects-hook-command-launch-gate.json` SHA-256 `824c9e7bebb0ff5777381e8134b516d512f77629e47cb91d54c9fb089ba999e6` confirms the exact-name Windows/local60s x1/fail/retries0 override. Run `b5b8821a-5a5e-4a3a-984c-2204b4623ef6`: native0, 1PASS, 42 excluded, 33.934s. Execution `f21-effects-hook-command-execution-final.json` SHA-256 `2311dc2b9a38dd66bd73a59d0e198c0f69a0e6bf85ba6f5e6a19ac9e99b41cd7`, raw log SHA-256 `ded97bd5db569c9394f20c54db8e6c6568d0ff370c7f644cade462176d955942`, binds all12 controlled invocations:2 successful markers,1 duplicate-marker refusal and9 invalid-input refusals. The strengthened escaped quote/slash/surrogate-pair input, exact8192-unit acceptance/8193 refusal, both transcript forms and full marker equality are qualified in this controlled PowerShell environment. Every deliberate refusal requires exact exit73 and25 ASCII stderr bytes `covenant-hook-refused-v1\n`, empty stdout and clean terminal/cleanup; success requires exit0 and empty outputs.

Post-execution review `f21-effects-hook-command-post-execution-review.md` SHA-256 `a7e2e20dbfb3c5b1e9ad1169ec7d01b5115fd210124a4a0ce259022ce4bc82c5` PASS. Hygiene `f21-effects-hook-command-hygiene-final.json` SHA-256 `b8f9e2a98aa173eb685cb7473f43a287b489840c3715340bcbfe510417775897`: scoped Clippy/fixer0 without diagnostics or edits; owned fmt/check0 with only the stable nightly-only imports_granularity warning. Inverses `f21-effects-hook-command-format-inverses.json` SHA-256 `0e750f2950425caacecc8ef4c92013fbdf27a4ff69fbdc9ccf7423e9f2bb4952` restore the tested owner143/tests178 from final148/296; script bytes and assertions remain exact. No tests were rerun. Final five-path source/setup scope is +460/-0 before this ledger entry. Final review `f21-effects-hook-command-hygiene-review.md` SHA-256 `7cf42e870824e25039a1fbd68d69a439aa6e4c67c016fcba3e016a5c0b72b727` PASS.

This completes only the private P1 helper. Child outputs/PIDs/marker payloads are live assertions, not an independent raw archive. Actual Codex shell/session/thread and H integration, receipts, criterion5 and G4 remain unproven. Ownership is direct-child only, with no descendant containment or finite cleanup-return guarantee. Byte caps do not instrument allocator growth or concurrent-filesystem identity; Rust File drop cannot report a final close error, and exceptional marker I/O may retain a failed partial file. Unrelated exception paths were source-reviewed, not fault-injected. The inherited external serde E0463 Bazel gate remains open without cause, fix or retry. No release acceptance follows.

### F21-M ordinary MCP control - local phase complete

From base `a039d7161d76ec20d0f6080faebd2b2e91ed87ec`, the exact ordinary case passed as nextest run `150ec6f8-b3f2-4d0a-8a37-ca506a18fea8`; the eight-case bounded MCP protocol suite passed as `968895af-fe60-4332-aed6-e82d1fcf1489`. Receipt SHA-256 `9e47bd0818dc88e908ecd18ba11529f3b5e7a026b4417e83ec60de6928286a3f` records one successful actual CLI child, the settled ordinary model peer and the settled three-request MCP exchange. Current pinned behavior includes `_meta.progressToken: 0` on `tools/list` and the three standard MCP resource functions, yielding an exact ten-tool catalog; the fixture rejects other list metadata.

Portable validation passed five M cases and all 50 checkpoint-B regression cases. Scoped `just fix -p codex-cli` and required `just fmt` passed after testing; no tests were rerun. This is local instrumented M evidence only. F21 remains pending the constrained absence case, reconciliation, the exact F02-produced executable, and any required Bazel/product gate; no F12/F13/F14/F22/F31/F33/G4 or release acceptance follows.

### F21-C constrained effects absence - local phase complete
...
### F14 home-selection public routes - existing behavior verified
...
### A17: fanin-only MCP local checkpoint
...
resolved 15 seams, 57 tool rows and 184 authority rows; fork Python tests
